...
cusparseStatus_t CUSPARSEAPI cusparseGetVersion(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, version);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSetStream(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, streamId);
}
...
cusparseSetMatFillMode(cusparseMatDescr_t descrA, cusparseFillMode_t fillMode) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(descrA, fillMode);
}
...
cusparseSetMatDiagType(cusparseMatDescr_t descrA, cusparseDiagType_t diagType) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(descrA, diagType);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSaxpyi(cusparseHandle_t handle, int nnz,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, nnz, alpha, xVal, xInd, y, idxBase);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgthr(cusparseHandle_t handle, int nnz,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, nnz, y, xVal, xInd, idxBase);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSsctr(cusparseHandle_t handle, int nnz,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, nnz, xVal, xInd, y, idxBase);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSroti(cusparseHandle_t handle, int nnz,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, nnz, xVal, xInd, y, c, s, idxBase);
}
...
cusparseSgemvi(cusparseHandle_t handle, cusparseOperation_t transA, int m,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, transA, m, n, alpha, A, lda, nnz, xVal, xInd, beta,
                   y, idxBase, pBuffer);
}
...
cusparseSgemvi_bufferSize(cusparseHandle_t handle, cusparseOperation_t transA,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, transA, m, n, nnz, pBufferSize);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCsrmvEx_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, alg, transA, m, n, nnz, alpha, alphatype, descrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrmv(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, mb, nb, nnzb, alpha, descrA,
...
cusparseSbsrxmv(cusparseHandle_t handle, cusparseDirection_t dirA,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, sizeOfMask, mb, nb, nnzb, alpha,
                   descrA, bsrSortedValA, bsrSortedMaskPtrA, bsrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseXcsrsv2_zeroPivot(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, info, position);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScsrsv2_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, transA, m, nnz, descrA, csrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrsv2_solve(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, transA, m, nnz, alpha, descrA, csrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrsv2_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, mb, nnzb, descrA, bsrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrsv2_solve(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, mb, nnzb, alpha, descrA, bsrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrmm(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, transB, mb, n, kb, nnzb, alpha, descrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSgemmi(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, k, nnz, alpha, A, lda, cscValB, cscColPtrB,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrsm2_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, algo, transA, transB, m, nrhs, nnz, alpha, descrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrsm2_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, transXY, mb, n, nnzb, descrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrsm2_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, transB, mb, n, nnzb, descrA,
                   bsrSortedVal, bsrSortedRowPtr, bsrSortedColInd, blockSize,
                   info, pBufferSize);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrsm2_solve(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, transA, transXY, mb, n, nnzb, alpha, descrA,
                   bsrSortedVal, bsrSortedRowPtr, bsrSortedColInd, blockSize,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrilu02_numericBoost(
    ...
    float *boost_val) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(CUSPARSE_LIB_11_1,
                              cusparseScsrilu02_numericBoost);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, info, enable_boost, tol, boost_val);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScsrilu02_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, nnz, descrA, csrSortedValA, csrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrilu02_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, nnz, descrA, csrSortedVal, csrSortedRowPtr,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrilu02(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, nnz, descrA, csrSortedValA_valM, csrSortedRowPtrA,
                   csrSortedColIndA, info, policy, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSbsrilu02_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, mb, nnzb, descrA, bsrSortedVal,
...
cusparseStatus_t CUSPARSEAPI cusparseSgtsv2_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, dl, d, du, B, ldb, bufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgtsv2(cusparseHandle_t handle, int m,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, dl, d, du, B, ldb, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgtsv2StridedBatch_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, dl, d, du, x, batchCount, batchStride,
                   bufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgtsv2StridedBatch(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, dl, d, du, x, batchCount, batchStride, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgtsvInterleavedBatch_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, algo, m, dl, d, du, x, batchCount,
                   pBufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgtsvInterleavedBatch(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, algo, m, dl, d, du, x, batchCount, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgpsvInterleavedBatch_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, algo, m, ds, dl, d, du, dw, x, batchCount,
                   pBufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSgpsvInterleavedBatch(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, algo, m, ds, dl, d, du, dw, x, batchCount, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScsrgemm2_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, k, alpha, descrA, nnzA, csrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseXcsrgemm2Nnz(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, k, descrA, nnzA, csrSortedRowPtrA,
                   csrSortedColIndA, descrB, nnzB, csrSortedRowPtrB,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrgemm2(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, k, alpha, descrA, nnzA, csrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseScsrgeam2_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, alpha, descrA, nnzA, csrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseXcsrgeam2Nnz(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, descrA, nnzA, csrSortedRowPtrA,
                   csrSortedColIndA, descrB, nnzB, csrSortedRowPtrB,
...
cusparseSnnz(cusparseHandle_t handle, cusparseDirection_t dirA, int m, int n,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, m, n, descrA, A, lda, nnzPerRowCol,
                   nnzTotalDevHostPtr);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSnnz_compress(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, descr, csrSortedValA, csrSortedRowPtrA, nnzPerRow,
                   nnzC, tol);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScsr2csr_compress(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, descrA, csrSortedValA, csrSortedColIndA,
...
cusparseStatus_t CUSPARSEAPI cusparseSdense2csr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, descrA, A, lda, nnzPerRow, csrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseScsr2dense(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, descrA, csrSortedValA, csrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSdense2csc(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, descrA, A, lda, nnzPerCol, cscSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseScsc2dense(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, descrA, cscSortedValA, cscSortedRowIndA,
...
cusparseStatus_t CUSPARSEAPI cusparseXcoo2csr(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, cooRowInd, nnz, m, csrSortedRowPtr, idxBase);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcsr2coo(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, cooRowInd, nnz, m, cooRowInd, idxBase);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcsr2bsrNnz(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, m, n, descrA, csrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseScsr2bsr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, m, n, descrA, csrSortedValA, csrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSbsr2csr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, mb, nb, descrA, bsrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseSgebsr2gebsc_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, mb, nb, nnzb, bsrSortedVal, bsrSortedRowPtr,
...
cusparseStatus_t CUSPARSEAPI cusparseXgebsr2csr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, mb, nb, descrA, bsrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseSgebsr2csr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, mb, nb, descrA, bsrSortedValA,
                   bsrSortedRowPtrA, bsrSortedColIndA, rowBlockDim, colBlockDim,
...
cusparseStatus_t CUSPARSEAPI cusparseSgebsr2gebsr_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, mb, nb, nnzb, descrA, bsrSortedValA,
...
cusparseStatus_t CUSPARSEAPI cusparseXgebsr2gebsrNnz(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, dirA, mb, nb, nnzb, descrA, bsrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseXcoosort_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, cooRowsA, cooColsA, pBufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcoosortByRow(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, cooRowsA, cooColsA, P, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcsrsort_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, csrRowPtrA, csrColIndA,
                   pBufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcsrsort(cusparseHandle_t handle, int m,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, descrA, csrRowPtrA, csrColIndA, P,
                   pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcscsort_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, cscColPtrA, cscRowIndA,
                   pBufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseXcscsort(cusparseHandle_t handle, int m,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, descrA, cscColPtrA, cscRowIndA, P,
                   pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScsru2csr_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, csrVal, csrRowPtr, csrColInd, info,
                   pBufferSizeInBytes);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScsru2csr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, descrA, csrVal, csrRowPtr, csrColInd,
                   info, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseHpruneDense2csr_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, threshold, descrC, csrSortedValC,
...
cusparseStatus_t CUSPARSEAPI cusparseHpruneDense2csrNnz(
    cusparseHandle_t handle, int m, int n, const __half *A, int lda,
    const __half *threshold, const cusparseMatDescr_t descrC, int *csrRowPtrC,
    int *nnzTotalDevHostPtr, void *pBuffer) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(CUSPARSE_LIB_11_1, cusparseHpruneDense2csrNnz);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, threshold, descrC, csrRowPtrC,
                   nnzTotalDevHostPtr, pBuffer);
}
#endif // defined(__cplusplus)
...
cusparseStatus_t CUSPARSEAPI cusparseDpruneDense2csrNnz(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, threshold, descrC, csrSortedRowPtrC,
                   nnzTotalDevHostPtr, pBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseHpruneCsr2csr_bufferSizeExt(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnzA, descrA, csrSortedValA, csrSortedRowPtrA,
...
cusparseStatus_t CUSPARSEAPI cusparseHpruneDense2csrByPercentage_bufferSizeExt(
  ...
  LOAD_SPARSE_SYMBOL_FOR_ONCE(
      CUSPARSE_LIB_11_1, cusparseHpruneDense2csrByPercentage_bufferSizeExt);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, percentage, descrC, csrSortedValC,
                   csrSortedRowPtrC, csrSortedColIndC, info,
                   pBufferSizeInBytes);
}
#endif // defined(__cplusplus)
...
cusparseStatus_t CUSPARSEAPI cusparseSpruneDense2csrByPercentage_bufferSizeExt(
    ...
    const int *csrSortedColIndC, pruneInfo_t info, size_t *pBufferSizeInBytes) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(
      CUSPARSE_LIB_11_1, cusparseSpruneDense2csrByPercentage_bufferSizeExt);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, percentage, descrC, csrSortedValC,
                   csrSortedRowPtrC, csrSortedColIndC, info,
                   pBufferSizeInBytes);
...
cusparseStatus_t CUSPARSEAPI cusparseDpruneDense2csrByPercentage_bufferSizeExt(
    ...
    const int *csrSortedColIndC, pruneInfo_t info, size_t *pBufferSizeInBytes) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(
      CUSPARSE_LIB_11_1, cusparseDpruneDense2csrByPercentage_bufferSizeExt);
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, percentage, descrC, csrSortedValC,
                   csrSortedRowPtrC, csrSortedColIndC, info,
                   pBufferSizeInBytes);
...
cusparseStatus_t CUSPARSEAPI cusparseHpruneDense2csrNnzByPercentage(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, A, lda, percentage, descrC, csrRowPtrC,
                   nnzTotalDevHostPtr, info, pBuffer);
}
#endif // defined(__cplusplus)
...
cusparseStatus_t CUSPARSEAPI cusparseCsr2cscEx2(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, m, n, nnz, csrVal, csrRowPtr, csrColInd, cscVal,
...
cusparseCreateSpVec(cusparseSpVecDescr_t *spVecDescr, int64_t size, int64_t nnz,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spVecDescr, size, nnz, indices, values, idxType, idxBase,
                   valueType);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpVecGetIndexBase(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spVecDescr, idxBase);
}
...
cusparseSpVecGetValues(cusparseSpVecDescr_t spVecDescr, void **values) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spVecDescr, values);
}
...
cusparseCreateDnVec(cusparseDnVecDescr_t *dnVecDescr, int64_t size,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(dnVecDescr, size, values, valueType);
}
...
cusparseDnVecGetValues(cusparseDnVecDescr_t dnVecDescr, void **values) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(dnVecDescr, values);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpMatGetFormat(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, format);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpMatGetIndexBase(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, idxBase);
}
...
cusparseSpMatGetValues(cusparseSpMatDescr_t spMatDescr, void **values) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, values);
}
...
cusparseSpMatGetSize(cusparseSpMatDescr_t spMatDescr, int64_t *rows,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, nnz);
}
...
cusparseSpMatSetStridedBatch(cusparseSpMatDescr_t spMatDescr, int batchCount) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, batchCount);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCooSetStridedBatch(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, batchCount, batchStride);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCsrSetStridedBatch(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, batchCount, offsetsBatchStride,
...
cusparseStatus_t CUSPARSEAPI cusparseCreateCsr(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, nnz, csrRowOffsets, csrColInd,
...
cusparseCsrSetPointers(cusparseSpMatDescr_t spMatDescr, void *csrRowOffsets,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, csrRowOffsets, csrColInd, csrValues);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCreateCoo(cusparseSpMatDescr_t *spMatDescr,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, nnz, cooRowInd, cooColInd, cooValues,
...
cusparseStatus_t CUSPARSEAPI cusparseCreateCooAoS(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, nnz, cooInd, cooValues, cooIdxType,
                   idxBase, valueType);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCooAoSGet(cusparseSpMatDescr_t spMatDescr,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(spMatDescr, rows, cols, nnz, cooInd, cooValues, idxType,
                   idxBase, valueType);
}
...
cusparseStatus_t CUSPARSEAPI cusparseCreateDnMat(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(dnMatDescr, rows, cols, ld, values, valueType, order);
}
...
cusparseStatus_t CUSPARSEAPI cusparseDnMatGet(cusparseDnMatDescr_t dnMatDescr,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(dnMatDescr, rows, cols, ld, values, type, order);
}
...
cusparseDnMatGetValues(cusparseDnMatDescr_t dnMatDescr, void **values) {
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(dnMatDescr, values);
}
...
cusparseStatus_t CUSPARSEAPI cusparseDnMatSetStridedBatch(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(dnMatDescr, batchCount, batchStride);
}
...
cusparseStatus_t CUSPARSEAPI cusparseAxpby(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, alpha, vecX, beta, vecY);
}
...
cusparseStatus_t CUSPARSEAPI cusparseGather(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, vecY, vecX);
}
...
cusparseStatus_t CUSPARSEAPI cusparseScatter(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, vecX, vecY);
}
...
cusparseStatus_t CUSPARSEAPI cusparseRot(cusparseHandle_t handle,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, c_coeff, s_coeff, vecX, vecY);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpVV_bufferSize(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, opX, vecX, vecY, result, computeType, bufferSize);
}
...
cusparseSpVV(cusparseHandle_t handle, cusparseOperation_t opX,
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, opX, vecX, vecY, result, computeType,
                   externalBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpMV(
  ...
  LOG(TRACE, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, opA, alpha, matA, vecX, beta, vecY, computeType, alg,
                   externalBuffer);
}
...
cusparseStatus_t CUSPARSEAPI cusparseSpMM(
  ...
  LOAD_SPARSE_SYMBOL_FOR_ONCE(CUSPARSE_LIB_11_3, cusparseSpMM);
  // LOG(INFO, "Enter %s()", __FUNCTION__);
  return _real_sym(handle, opA, opB, alpha, matA, matB, beta, matC, computeType,
                   alg, externalBuffer);
}
#endif
...
cusparseStatus_t CUSPARSEAPI cusparseSpMM(
    ...
    const void *beta, cusparseDnMatDescr_t matC, cudaDataType computeType,
    cusparseSpMMAlg_t alg, void *externalBuffer) {
  LOAD_SPARSE_SYMBOL_FOR_ONCE(DGSPARSE_LIB, spmm_cuda_alg0);
  ...
  _real_sym((int)rows, (int)Bcols, reinterpret_cast<int *>(csrRowOffsets),
            ...
            reinterpret_cast<float *>(matCValues));
