...
void spmm_cuda_alg0(int m, int k, int *rowptr, int *colind, float *values,
                    float *dense, float *out);

void spmm_cuda_alg1(int m, int k, int *rowptr, int *colind, float *values,
                    float *dense, float *out);

void spmm_cuda_alg2(int m, int k, int *rowptr, int *colind, float *values,
                    float *dense, float *out);

void spmm_cuda_alg3(int m, int k, int *rowptr, int *colind, float *values,
                    float *dense, float *out);
